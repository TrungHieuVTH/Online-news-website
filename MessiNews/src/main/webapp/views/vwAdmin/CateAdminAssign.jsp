...
<jsp:useBean id="editor" scope="request" type="com.messi.king.messinews.model.bean.Users"/>
...
<jsp:useBean id="cates" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Categories>"/>
