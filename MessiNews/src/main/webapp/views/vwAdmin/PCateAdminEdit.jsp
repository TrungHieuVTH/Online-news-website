...
<jsp:useBean id="pcate" scope="request" type="com.messi.king.messinews.model.bean.ParentCategories"/>
    ...
    <form id="form" action="" method="post">
      <div class="d-flex justify-content-center bgColorGray">
        ...
        <div style="width: 70%; background-color: white" class="m-4 p-3">
          ...
          <hr>
          <h5>Đang chỉnh chuyên mục lớn: ${pcate.name_parent_cate}</h5>
          <br>
          <label for="namePCate">Tên chuyên mục lớn</label>
          ...
          <div id="save" align="end">
            ...
            <button class="btn btn-success" type="submit" formaction="${pageContext.request.contextPath}/Admin/Component/EditPCate?id=${pcate.id}">
