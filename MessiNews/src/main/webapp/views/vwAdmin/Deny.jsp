                    ...
                    <div style=" width: 100%">
                        ...
                        <div align="end">
                            <c:if test="${authUser.role == 3}">
                                <a href="${pageContext.request.contextPath}/Admin/Articles/ArticleList"
                            ...
                            <button class="btn btn-success" type="submit" formaction="${pageContext.request.contextPath}/Admin/Articles/Deny?id=${article.id}">
