...
<jsp:useBean id="tag" scope="request" type="com.messi.king.messinews.model.bean.Tags"/>
        ...
        <form id="form" action="" method="post">
            <div class="d-flex justify-content-center bgColorGray">
                ...
                <div style="width: 70%; background-color: white" class="m-4 p-3">
                    ...
                    <hr>
                    <h5>Đang chỉnh nhãn: ${tag.name_tags}</h5>
                    <br>
                    <label for="nameTag">Tên nhãn</label>
                    ...
                    <div id="save" align="end">
                        ...
                        <button class="btn btn-success" type="submit" formaction="${pageContext.request.contextPath}/Admin/Component/EditTag?id=${tag.id}">
