                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <c:forEach items="${allPCategories}" var="c">
                                <a class="dropdown-item"
                                   onclick="choosePCat('${pageContext.request.contextPath}/Admin/Component/AddCate?pcateId=${c.id}','${c.name_parent_cate}')">${c.name_parent_cate}</a>
                            </c:forEach>
                        </div>
                    </div>
                    <hr>
                    <div id="save" align="end">
                        <a href="${pageContext.request.contextPath}/Admin/Component/List" class="btn btn-secondary mr-2">
