                    ...
                    <div class="w-100 d-flex">
                        <table width="100%" cellpadding="15px">
                                                ...
                                                <c:otherwise>
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <c:forEach items="${Categories}" var="d">
                                                            <c:if test="${c.id == d.parent_cate_id}">
                                                                <a class="dropdown-item"
                                                                   onclick="btCatClick('btChillCat${c.id}','${d.name_category}','${pageContext.request.contextPath}/Admin/Articles/Accept?id=${article.id}&idCat=${d.id}')">${d.name_category}</a>
                                                            </c:if>
                                                        </c:forEach>
                                                    </div>
                                                </c:otherwise>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="radio" id="normal" name="kinds_id" value="0">
                                    <label for="normal">Thường</label><br>
                                    <input type="radio" id="premium" name="kinds_id" value="1">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <c:forEach items="${tags}" var="e">
                                        <input class="ckBox" type="checkbox" id="checkBox${e.id}" value="${e.id}">
                                        <label for="checkBox${e.id}">${e.name_tags} &ensp;</label>
                                    </c:forEach>
                                </td>
                            </tr>
                        </table>
