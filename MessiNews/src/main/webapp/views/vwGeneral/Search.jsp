...
<jsp:useBean id="allArticle" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Articles>"/>
<jsp:useBean id="byTitle" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Articles>"/>
<jsp:useBean id="byAbstract" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Articles>"/>
<jsp:useBean id="byContent" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Articles>"/>
