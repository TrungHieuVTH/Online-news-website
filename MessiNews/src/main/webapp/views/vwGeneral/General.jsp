...
<jsp:useBean id="top10AllCate" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Articles>"/>
<jsp:useBean id="top5AllCateInWeek" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Articles>"/>
<jsp:useBean id="latestNewsAllCate" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Articles>"/>
<jsp:useBean id="newest10PerCate" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Articles>"/>
