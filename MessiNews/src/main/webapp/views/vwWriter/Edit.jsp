...
<jsp:useBean id="categories" scope="request" type="com.messi.king.messinews.model.bean.Categories"/>
<jsp:useBean id="allTags" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Tags>"/>
<jsp:useBean id="tags" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Tags>"/>
<jsp:useBean id="art" scope="request" type="com.messi.king.messinews.model.bean.Articles"/>
